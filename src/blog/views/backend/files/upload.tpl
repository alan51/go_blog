        ...
        <div class="content-frame">
            ...
            <div class="content-frame-top">
                ...
                <div class="pull-right">
                    <button class="btn btn-danger" id="choose_select">确定</button>
            ...
            <div class="content-frame-body content-frame-body-left">
                ...
                <div class="gallery" id="links">
                    <<< range $k,$img := .images >>>
                    <a class="gallery-item" style="width: 25%;height: 200px" data-url="<<< $img.Url >>>" data-id="<<< $img.Id >>>" href="<<< $img.Url >>>" title="Nature Image 1" data-gallery>
                        <div class="image">
...
<script>
    ...
    $('#choose_select').on("click", function () {
        data = []
        ...
        $(".gallery-item").each(function(){
            ...
            if(wr.hasClass("checked")){
                ...
                data.push(url)
                parent.$('.img_show').html('<img style="width: 200px" src="'+url+'">');
                parent.$('#img').val(url);
            }
        })
        if(!data.length) {
