    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="UserName" lay-verify="required" placeholder="请输入登录名" autocomplete="off"
                       class="layui-input" value="<<< .user_info.UserName >>>">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="NickName" lay-verify="required" placeholder="请输入昵称" autocomplete="off"
                       class="layui-input" value="<<< .user_info.NickName >>>">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                ...
                <div id="hidden_input">
                    <input type="hidden" name="Img" id="img" value="<<< .user_info.Img >>>">
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="Status" value="1" title="启用" <<< if eq .user_info.Status 1>>> checked="" <<< end >>>>
                <input type="radio" name="Status" value="2" title="禁用" <<< if eq .user_info.Status 2>>> checked="" <<< end >>>>
            </div>
        </div>
